...
init_logger();
import { existsSync as existsSync13, mkdirSync as mkdirSync7, statSync as statSync6, unlinkSync as unlinkSync3, writeFileSync as writeFileSync6 } from "fs";
...
function startWorker() {
  ...
  const entryPath = join12(homedir10(), ".claude-memory-hub", "dist", "worker.js");
  ...
  try {
    const dir = join12(homedir10(), ".claude-memory-hub");
    if (!existsSync13(dir))
